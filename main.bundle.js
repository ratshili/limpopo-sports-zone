...
var ClubsListingComponent = /** @class */ (function () {
    function ClubsListingComponent(dialog, afs, af, competitionServices, clubsService, changeDetectorRef, media) {
        ...
        this.displayedColumns = ['name', 'homeGround', 'competitions', 'contacts', 'actions'];
        this.type = 'club';
...
var CompetitionListingsComponent = /** @class */ (function () {
    function CompetitionListingsComponent(dialog, afs, af, competitionServices) {
        var _this = this;
        this.dialog = dialog;
        this.afs = afs;
        this.af = af;
